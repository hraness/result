...
The root `AGENTS.md` is the repository's normative control plane. Its rules apply before deeper lookup. Result is the dependency-free `@hraness/result` package for explicit recoverable failure and optional values.
